...
import { Eye, EyeOff, Loader2, Phone, Lock, ArrowRight, KeyRound } from 'lucide-react';
...
export default function ResetPasswordPage() {
  const [step, setStep] = useState('phone'); // 'phone', 'otp', or 'reset'
  ...
  const resendOtp = async () => {
    setIsLoading(true);
    try {
      await axiosInstance.post('/auth/forgot-password', { phone: phoneNumber });
