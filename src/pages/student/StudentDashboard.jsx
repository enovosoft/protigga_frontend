...
export default function StudentDashboard() {
  ...
  return (
    <>
      <Helmet>
        <title> ড্যাশবোর্ড - Protigya</title>
        <meta
          name="description"
          content="Protigya-তে আপনার শিক্ষার্থী ড্যাশবোর্ডে অ্যাক্সেস করুন। কোর্স, বই, পরীক্ষা এবং আরও অনেক কিছু পরিচালনা করুন। বাংলাদেশের শীর্ষ অনলাইন শিক্ষা প্ল্যাটফর্ম।"
        />
        <meta
          name="keywords"
          content="শিক্ষার্থী ড্যাশবোর্ড, Protigya, অনলাইন শিক্ষা, কোর্স, বই, পরীক্ষা, বাংলাদেশ"
        />
        <meta
          property="og:title"
          content="আমার ড্যাশবোর্ড - Protigya | শিক্ষার্থী পোর্টাল"
        />
        <meta
          property="og:description"
          content="Protigya-তে আপনার শিক্ষার্থী ড্যাশবোর্ডে অ্যাক্সেস করুন। কোর্স, বই, পরীক্ষা এবং আরও অনেক কিছু পরিচালনা করুন।"
        />
