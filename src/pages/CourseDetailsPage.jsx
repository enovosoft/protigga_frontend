                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground mt-1">
                            {course.instructor.bio || 'Experienced educator dedicated to student success.'}
                          </p>
                        </div>
                      </div>
                    ) : (
                    ...
                    {relatedCourses.map((relatedCourse) => (
                      ...
                      >
                        ...
                        <CardContent className="p-4">
                          ...
                          <p className="text-xl font-bold text-primary">৳{relatedCourse.price}</p>
                        </CardContent>
                      </Card>
                    ))}
                  </div>
                  ...
                  <CardContent className="p-6 space-y-4">
                    ...
                    <div className="border-t border-border pt-4 space-y-3">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium text-foreground">{course.quiz_count || 0}</span>
                      </div>
