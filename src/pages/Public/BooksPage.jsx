...
export default function BooksPage() {
  ...
  return (
    <>
      <Helmet>
        <title>বইসমূহ - প্রতিজ্ঞা | শিক্ষামূলক বই কিনুন</title>
        <meta
          name="description"
          content="প্রতিজ্ঞার সকল শিক্ষামূলক বই দেখুন। HSC, SSC এবং বিভিন্ন প্রতিযোগিতামূলক পরীক্ষার জন্য মানসম্পন্ন বই। হোম ডেলিভারি এবং ক্যাশ অন ডেলিভারি সুবিধা।"
        />
        <meta
          property="og:title"
          content="বইসমূহ - প্রতিজ্ঞা | শিক্ষামূলক বই কিনুন"
        />
        <meta
          property="og:description"
          content="প্রতিজ্ঞার সকল শিক্ষামূলক বই দেখুন। HSC, SSC এবং বিভিন্ন প্রতিযোগিতামূলক পরীক্ষার জন্য মানসম্পন্ন বই।"
        />
        <meta property="og:image" content="/logo.png" />
        <meta property="og:url" content="https://www.protigya.com/books" />
        <link rel="canonical" href="https://www.protigya.com/books" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Browse our collection of educational books to support your
                studies
              </p>
            </motion.div>
                    ...
                    <div className="flex justify-center gap-2 sm:gap-3 flex-wrap max-w-3xl mx-auto">
                      ...
                      {batches.map((batch) => (
                        <Button
                          key={batch}
                          variant={
                            activeFilter === batch ? "default" : "outline"
                          }
